...
#define UICC_PARAMS_DESC {                                              \
      {"imsi",             "USIM IMSI\n",             0,   .strptr=&uicc->imsiStr,     .defstrval="242881234500088",                  TYPE_STRING,    0 }, \
      {"nmc_size"          "number of digits in NMC", 0,   .iptr=&uicc->nmc_size,      .defintval=2,                                  TYPE_INT,       0 }, \
      {"key",              "USIM Ki\n",               0,   .strptr=&uicc->keyStr,      .defstrval="449c4b91aeacd0ace182cf3a5a72bfa1", TYPE_STRING,    0 }, \
      {"opc",              "USIM OPc\n",              0,   .strptr=&uicc->opcStr,      .defstrval="1006020f0a478bf6b699f15c062e42b3", TYPE_STRING,    0 }, \
